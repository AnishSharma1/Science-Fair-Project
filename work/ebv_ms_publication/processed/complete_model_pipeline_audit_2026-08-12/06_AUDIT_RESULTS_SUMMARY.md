...
- Saved job directories discovered: **150** (focused_af3_rerun: 60, monday_af3_full: 80, new_background_af3: 10).
- Unique candidate/peptide/seed jobs after deduplication: **114** (focused_af3_rerun: 24, monday_af3_full: 80, new_background_af3: 10).
- Canonical study jobs with complete parsed pMHC outputs: **109**.
...
No eligible pair has a completed length/bin-matched structural background comparator. AF3 samples and seed repeats are technical sensitivity analyses rather than biological replicates. The score sheet therefore prioritizes candidates for a computational paper and future testing; it does not establish presentation, shared-TCR recognition, cross-reactivity, molecular mimicry, or an MS mechanism.
